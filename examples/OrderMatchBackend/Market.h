...
public:
  ...
  double getLastTradePrice() const { return m_lastTradePrice; }
  long getLastTradeSize() const { return m_lastTradeSize; }
  long getTotalVolume() const { return m_totalVolume; }
  bool getBestBid(double& price, long& size) const;
  bool getBestAsk(double& price, long& size) const;
...
private:
  ...
  long m_lastTradeSize = 0;
  long m_totalVolume = 0;
};
